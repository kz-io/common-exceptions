/**
 * This file contains tests for the ValueException class.
 *
...
describe('ValueException', () => {
  it('inheritance tree', () => {
    const exception = new ValueException('This is a test message.');
  ...
  it('new(message)', () => {
    fixturesNewMessage.forEach(([args, expected]) => {
      const [message] = args;
      const exception = new ValueException(message);
  ...
  it('new(message, data)', () => {
    fixturesNewMessageData.forEach(([args, expected]) => {
      ...
      const exception = new ValueException(message, data);
