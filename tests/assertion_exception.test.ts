/**
 * This file contains tests for the AssertionException class.
 *
...
describe('AssertionException', () => {
  it('inheritance tree', () => {
    const exception = new AssertionException('This is a test message.');
  ...
  it('new(message)', () => {
    fixturesNewMessage.forEach(([args, expected]) => {
      const [message] = args;
      const exception = new AssertionException(message);
  ...
  it('new(message, data)', () => {
    fixturesNewMessageData.forEach(([args, expected]) => {
      ...
      const exception = new AssertionException(message, data);
