/**
 * This file contains tests for the ConnectionException class.
 *
...
describe('ConnectionException', () => {
  it('inheritance tree', () => {
    const exception = new ConnectionException('This is a test message.');
  ...
  it('new(message)', () => {
    fixturesNewMessage.forEach(([args, expected]) => {
      const [message] = args;
      const exception = new ConnectionException(message);
  ...
  it('new(message, data)', () => {
    fixturesNewMessageData.forEach(([args, expected]) => {
      ...
      const exception = new ConnectionException(message, data);
