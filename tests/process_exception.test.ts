/**
 * This file contains tests for the ProcessException class.
 *
...
describe('ProcessException', () => {
  it('inheritance tree', () => {
    const exception = new ProcessException('This is a test message.');
  ...
  it('new(message)', () => {
    fixturesNewMessage.forEach(([args, expected]) => {
      const [message] = args;
      const exception = new ProcessException(message);
  ...
  it('new(message, data)', () => {
    fixturesNewMessageData.forEach(([args, expected]) => {
      ...
      const exception = new ProcessException(message, data);
